...
namespace ImmortalLang
{
    ...
    {
    	public static readonly byte block = 0x02;
    	public static readonly byte loop = 0x03;
    	...
    	public static readonly byte _if = 0x04;
		...
		public static readonly byte  i32_load = 0x28; // $flags: memflags, $offset: varuPTR ($base: iPTR) : (i32) M, G
		public static readonly byte  i64_load = 0x29; // $flags: memflags, $offset: varuPTR ($base: iPTR) : (i64) M, G
		public static readonly byte  f32_load = 0x2a; // $flags: memflags, $offset: varuPTR ($base: iPTR) : (f32) M, E
		public static readonly byte  f64_load = 0x2b; // $flags: memflags, $offset: varuPTR ($base: iPTR) : (f64) M, E
		
		public static readonly byte  i32_store = 0x36; // $flags: memflags, $offset: varuPTR ($base: iPTR, $value: i32) : () M, G
		public static readonly byte  i64_store = 0x37; // $flags: memflags, $offset: varuPTR ($base: iPTR, $value: i64) : () M, G
		public static readonly byte  f32_store = 0x38; // $flags: memflags, $offset: varuPTR ($base: iPTR, $value: f32) : () M, F
		public static readonly byte  f64_store = 0x39; // $flags: memflags, $offset: varuPTR ($base: iPTR, $value: f64) : () M, F
