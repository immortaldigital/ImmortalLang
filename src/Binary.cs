...
namespace ImmortalLang
{
	public class Binary
	{
		...
		public byte[] getBinary()
		{
			...
			codeDef.InsertRange(0, Encoder.unsignedLEB128(functions.Count));
			typeDef.InsertRange(0, Encoder.unsignedLEB128(functions.Count));
			exportDef.InsertRange(0, Encoder.unsignedLEB128(exportCount));
